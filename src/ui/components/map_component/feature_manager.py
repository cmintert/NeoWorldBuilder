...
class FeatureManager(QObject):
    ...
    def _update_pin_position_with_viewport(
        ...
        # NOTE: No centering offset needed here anymore!
        # The feature container is now positioned correctly to handle centering
    ...
    def get_feature_count(self) -> Dict[str, int]:
        ...
        """
        return {"pins": len(self.pins), "lines": len(self.lines)}
