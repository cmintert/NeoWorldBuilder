...
class DrawingManager(QObject):
    ...
    def add_point(self, original_x: int, original_y: int, scaled_x: float, scaled_y: float) -> bool:
        ...
        logger.debug(f"Added point to line: ({original_x}, {original_y}) - "
    ...
    def set_drawing_style(self, color: Optional[str] = None, width: Optional[int] = None, 
                         style: Optional[Qt.PenStyle] = None) -> None:
